  ...
  internal = rec {
    ...
    crates = {
      ...
      "atom_syndication" = rec {
        ...
        version = "0.9.0";
        edition = "2018";
        sha256 = "12q0y041rfvwilx7mwlp4fb7nvia8v0jb2ykw7xw8j6wmskjy2vx";
        authors = [
      ...
      "diligent-date-parser" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "1556s4mi43m0b4hwk5zydhi4n4jnk36mcq1w9fqh7ka6q7d2p16r";
        authors = [
      ...
      "futures-retry" = rec {
        ...
        version = "0.5.0";
        edition = "2018";
        sha256 = "083lp8lhd2xgg52layzqrv6w85qzw3h77acp47q8k599cisgx6vm";
        authors = [
      ...
      "github-label-feed" = rec {
        crateName = "github-label-feed";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "github-label-feed"; path = "src/main.rs"; }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./.; };
        authors = [
          "tilpner <till@hoeppner.ws>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "log" = rec {
        ...
        resolvedDefaultFeatures = [ "max_level_off" "release_max_level_off" "std" ];
      };
      "maplit" = rec {
        crateName = "maplit";
        version = "1.0.2";
      ...
      "reqwest" = rec {
        ...
        version = "0.10.6";
        edition = "2018";
        sha256 = "1066brizayzb974qwh7f1f6lpmi8hnya9qs36ksjcprhiciwk0iv";
        authors = [
          "Sean McArthur <sean@seanmonstar.com>"
        ];
        dependencies = [
      ...
      "smol" = rec {
        ...
        resolvedDefaultFeatures = [ "tokio" "tokio02" ];
      };
      "socket2" = rec {
        crateName = "socket2";
        version = "0.3.12";
      ...
      "sqlformat" = rec {
        ...
        version = "0.1.0";
        edition = "2018";
        sha256 = "0cf609g4hsfk1fmcnnr6zk8gwv0gikdwrwqva4p0lwp1fr2lmrjw";
        authors = [
      ...
      "sqlx" = rec {
        ...
        version = "0.3.5";
        edition = "2018";
        sha256 = "0f5h0clgnvmj0lwlrhsdc18v6vzc1mk8sw3qwx4vwpq8h36wlx49";
        authors = [
        ...
        resolvedDefaultFeatures = [ "macros" "runtime-tokio" "sqlite" "sqlx-macros" ];
      };
      "sqlx-core" = rec {
        crateName = "sqlx-core";
        version = "0.3.5";
        edition = "2018";
        sha256 = "0wv2414dknzykb9qrrjh2j7cbhzm1mriliq9qpm4474ldx1mmb48";
        authors = [
          "Ryan Leckey <leckey.ryan@gmail.com>"
          "Austin Bonander <austin.bonander@gmail.com>"
          "Zachery Gyurkovitz <zgyurkovitz@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "async-native-tls" "libsqlite3-sys" "runtime-tokio" "sqlite" "tokio" ];
      };
      "sqlx-macros" = rec {
        crateName = "sqlx-macros";
        version = "0.3.5";
        edition = "2018";
        sha256 = "1037bvqp3kr4rw2vhyq8qcqyam9pb9d6c50vh4nr5x9sg25yfany";
        procMacro = true;
        authors = [
          "Ryan Leckey <leckey.ryan@gmail.com>"
          "Austin Bonander <austin.bonander@gmail.com>"
        ...
        resolvedDefaultFeatures = [ "lazy_static" "runtime-tokio" "sqlite" "tokio" ];
      };
      "strsim 0.8.0" = rec {
        crateName = "strsim";
        version = "0.8.0";
      ...
      "tokio" = rec {
        ...
        resolvedDefaultFeatures = [ "blocking" "default" "dns" "fnv" "fs" "futures-core" "io-driver" "io-util" "iovec" "lazy_static" "memchr" "mio" "num_cpus" "rt-core" "rt-threaded" "slab" "stream" "sync" "tcp" "time" ];
      };
      "tokio-tls" = rec {
        crateName = "tokio-tls";
        version = "0.3.1";
